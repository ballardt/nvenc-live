...
We are creating  entire videos with GOP lenghts of 16. This implies an average quality change duration of 8 seconds, which can be reduced by reducing the GOP length. While adapting much slower than our earlier work~\cite{ism-2018}, it can work with arbitrary clients. NVenc does not generate SI or SP frames for faster transitions.
