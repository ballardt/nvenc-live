...
\begin{figure*}[h!]
    ...
    \hfill
	\subfigure[SSIM scores between input and tiles video. "Middle" quality uses a checkerboard pattern. Hardware alignment rules require padding for 3, 5, 6 and 7 rows; 5 rows is given as example. Other rows are well-aligned; 8 rows are given as example]{
